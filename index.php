...
if ($_POST) {
    ...
    if (count($error)) {
        $error_list_imploded = implode('<br>', $error);
        $error_markup = '<div class="alert alert-danger" role="alert"><p><strong>There were error(s) in your form:</strong></p>' . $error_list_imploded . '</div>';
    } else {
        ...
        if(mail($emailTo, $subject, $message, $headers)) {
            ...
            $error_markup = '<div class="alert alert-danger" role="alert"><strong>Your message could not be sent.</strong>' . $error_list_imploded . '</div>';
        }
    }
}
?>
